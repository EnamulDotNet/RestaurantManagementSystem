...
namespace RMS.BLL
{
    public class UserInfoBiz
    {
        ...
        public string CreateUserInfo(UserInfo objUserInfo)
        {
            ...
            try
            {
                noOfAffacted = objDataAccess.ExecuteNonQuery(objDbCommand, "[rdb].[uspCreateUserInfo]", CommandType.StoredProcedure);
        ...
        public DataTable GetUserByAutoComplete(string searchText)
        {
            objDataAccess = DataAccess.NewDataAccess();
            objDbCommand = objDataAccess.GetCommand(true, IsolationLevel.ReadCommitted);
            DbDataReader objDbDataReader = null;
