...
namespace RMS.BLL
{
    public class DesignationBiz
    {
        ...
        public string CreateDesignation(Designation objDesignation)
        {
            ...
            try
            {
                noOfAffacted = objDataAccess.ExecuteNonQuery(objDbCommand, "[rdb].[uspCreateDesignation]", CommandType.StoredProcedure);
        ...
        public void UpdateDesignation(Designation objDesignation)
        {
            int noOfAffacted = 0;
