        ...
        <table>
            <tr>
                <td style="width: 400px;">
                    <asp:TextBox ID="txtUserName" ClientIDMode="Static" AutoPostBack="True" runat="server" CssClass="form-control"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>

    <asp:Panel ID="pnlDisplayUser" runat="server">

        <asp:GridView ID="gvDisplayUserInfo" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="gvDisplayUserInfo_PageIndexChanging" OnSelectedIndexChanged="gvDisplayUserInfo_SelectedIndexChanged" DataKeyNames="UserId, RoleId" OnRowDataBound="gvDisplayUserInfo_RowDataBound">
